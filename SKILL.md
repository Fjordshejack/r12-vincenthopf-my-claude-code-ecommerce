        ---
        name: "r00-vincenthopf-My-Claude-Code--ecommerce"
        description: >
          🛒 E-commerce & Retail skill suite derived from vincenthopf/My-Claude-Code.
...
- `/marketplace-audit` — Amazon/eBay listing health score, Buy Box eligibility and keyword gap
        ...
        ```bash
        # Install this skill
        cp -r . ~/.claude/skills/r00-vincenthopf-My-Claude-Code--ecommerce/

        # In Claude Code
        /read ~/.claude/skills/r00-vincenthopf-My-Claude-Code--ecommerce/SKILL.md
        ```
